...
void industrial_theme_activate(bool setAsDefaultStyle, QQmlEngine* engine)
{
    qmlRegisterSingletonType<IndustrialTheme>("Industrial.Controls", 1, 0, "Theme",
    ...
    qmlRegisterUncreatableType<IndustrialThemeFactors>("Industrial.Controls", 1, 0, "ThemeFactors", "Uncreatable");
    qmlRegisterUncreatableType<IndustrialThemeColors>("Industrial.Controls", 1, 0, "ThemeColors", "Uncreatable");
